...
function PrestudyQuestionnaire() {
  const participant = useSelector(state => state.participantID);
  const link = "https://docs.google.com/forms/d/e/1FAIpQLScj18067dFHFa-mR2pfYUKkKJIbLxHQoVBhLnOT5QpZF--_iw/viewform?usp=pp_url&entry.1586976047=" + participant
        ...
        <div className="px-10">
          <div className="flex flex-col items-center bg-white max-w-4xl rounded-2xl px-10 py-8 shadow-lg hover:shadow-2xl transition duration-500">
            <div>
              ...
              Please complete the pre-study questionnaire on your mobile device before continuing.
              </h1>
              <br/>
            </div>
