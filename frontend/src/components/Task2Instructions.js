      ...
      <div className="flex-grow bg-gray-100 flex items-center justify-center">
        <div className="px-10">
          <div className="flex flex-col items-center bg-white max-w-4xl rounded-2xl px-10 py-8 shadow-lg hover:shadow-2xl transition duration-500">
            <div>
              <h1 className="text-lg font-semibold font-black">Task 2</h1>
              <br />
              <p>
                {" "}
              ...
              <p>
                ...
                mobile device. An intervention technique will be presented to
                help you recover from distractions.{" "}
              </p>
              <br />
              <p>
                In this module, the video subtitles will stack until you have
                finished reading them. If there are too many subtitles, the
                video will pause. Once you have finished reading the subtitles
                they will disappear. At the end of the video, you will be
                presented with content comprehension questions.
              </p>
              <br />
...
export default Task2Insructions;
