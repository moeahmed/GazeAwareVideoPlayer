      ...
      <div className="flex-grow bg-gray-100 flex items-center justify-center">
        <div className="px-10">
          <div className="flex flex-col items-center bg-white max-w-4xl rounded-2xl px-10 py-8 shadow-lg hover:shadow-2xl transition duration-500">
            <div>
              <h1 className="text-lg font-semibold font-black">Task 3</h1>
              <br />
              <p>
                {" "}
              ...
              <br />
              <p>
                In this module, you will be presented with a foreign language
                audio track. The video's audio language track will change
                depending on whether or not you are focused on watching the
                video. At the end of the video, you will be presented with
...
export default Task3Insructions;
